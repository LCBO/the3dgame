...
if ($setting['site_offline'] == 1) {
    echo '<input name="site_offline" type="radio" value="0" /> Online <input name="site_offline" type="radio" value="1" checked="checked" /> Offline';
} else {
	echo'<input name="site_offline" type="radio" value="0" checked="checked" /> Online <input name="site_offline" type="radio" value="1" /> Offline';
}
?>
</div></div><br style="clear:both" />
...
if($setting['play_limit'] == 1) {
    echo '<input name="play_limit" type="radio" value="1" checked="checked" /> On <input name="play_limit" type="radio" value="0" /> Off';
} else {
    echo'<input name="play_limit" type="radio" value="1" /> On <input name="play_limit" type="radio" value="0" checked="checked" /> Off';
}
?>
</div></div><br style="clear:both" />
...
<div class="settings_container"><div class="settings_lable">Fullscreen mode <a href="#" onmouseover="Tip('Javascript overlay allows the game to continue being played from the current point and highscore tracking. Windowed is for compatibility issues.')" onmouseout="UnTip()">[?]</a></div><div class="settings_element">
 <?php
 if($setting['fullscreen_mode'] == 1) {
    echo '<input name="fullscreen_mode" type="radio" value="1" checked="checked" /> Javascript overlay <input name="fullscreen_mode" type="radio" value="0" /> Window';
} else {
    echo'<input name="fullscreen_mode" type="radio" value="1" /> Javascript overlay <input name="fullscreen_mode" type="radio" value="0" checked="checked" /> Window';
}
?>
</div></div><br style="clear:both" />
