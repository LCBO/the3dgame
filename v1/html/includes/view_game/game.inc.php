...
if ($show == 1) {
    ...
    $row2['url'] = CDNUrlConvert($row2['url']);
...
<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=9,0,28,0" width="<?= $width;?>" height="<?= $height;?>">
    ...
    <embed src="<?= $flash_url;?>" quality="high" pluginspage="http://www.adobe.com/shockwave/download/download.cgi?P1_Prod_Version=ShockwaveFlash" type="application/x-shockwave-flash" width="<?= $width;?>" height="<?= $height;?>" scale="exactfit"></embed>
</object>
<?php
	}
