...
TOPIC_POINTS = $setting[points_forum_topic];";
...
<script type="text/javascript" src="<?php echo $setting['site_url'].'/includes/';?>carousel_srcoll.js"></script>
<script type="text/javascript" src="<?php echo $setting['site_url'].'/includes/';?>html5.js"></script>
<?php if ($user['admin'] == 1) { ?>
