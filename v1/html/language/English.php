...
define("GAME_POPULAR", 'Most Popular Free 3D Games Online');
define("GAME_PALYED", 'Recently Played');
define("GAME_NEW", 'New Game');
define("GAME_RATED", 'Top Rated');
...
define("GAME_HOW_TO_PALY", 'How To Paly');
define("GAME_SHARE", 'Share');
define("GAME_SUGGESTION", 'Suggestion');
...
define("CATEGORY_MOST", 'Most played');
define("CATEGORY_BEST", 'Best rated');
...
define('REG_ERROR9', 'Your E-mail is not in conformity with the rules.');
define('REG_ERROR10', "You didn't enter a username.");
define('REG_ERROR11', "Password for minimum six.");
